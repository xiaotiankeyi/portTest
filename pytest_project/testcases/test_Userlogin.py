...
class Testlogin(startup):
    ...
    @pytest.mark.parametrize('value', rand_yaml_apidata(file=api_data_path,))
    ...
    case_data = rand_excel(sheet_name='接口测试')
...
if __name__ == "__main__":
    pytest.main(['-vs', '-q', 'test_Userlogin.py::Testlogin::test_case_01',])
